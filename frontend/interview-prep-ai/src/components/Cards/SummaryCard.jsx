...
const SummaryCard = ({
  ...
  return (
    <div className="bg-white border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group"
     onClick={onSelect}>
        <div 
        ...
        >
            <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 rounded-md bg-white flex items-center justify-center mr-3">
