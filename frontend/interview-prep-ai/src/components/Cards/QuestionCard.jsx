  ...
  <div className="bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group">
    <div className="flex items-start justify-between cursor-pointer">
        <div className="flex items-start gap-3.5">
            <span className="text-xs md:text-[14px] font-medium text-gray-400 leading-[18px]">
                Q
            </span>
        ...
        <div className="flex items-center justify-end ml-4 relative gap-2">
            ...
            >
                <button 
                className='flex items-center gap-2 text-xs text-indigo-800 font-medium bg-indigo-300 px-3 py-1 mr-2 rounded text-nowrap border border-indigo-50 hover:border-indigo-200 cursor-pointer'
                onClick={onTogglePin}
                >
                    {isPinned ? (
