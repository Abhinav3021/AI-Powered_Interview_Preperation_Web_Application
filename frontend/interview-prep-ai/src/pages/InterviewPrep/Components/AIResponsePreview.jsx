    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-300">
      <div className="flex justify-between items-center px-4 py-2 bg-gray-100 border-b border-gray-300">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs text-gray-600 font-semibold uppercase tracking-wide">{language || 'Code'}</span>
        </div>
        <button onClick={copyCode} className=" text-gray-500 hover:text-gray-800 focus:outline-none  relative group">
